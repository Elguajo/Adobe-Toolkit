...
удалённых Adobe-приложений из Launch Services и перезапускает Dock, чтобы в Launchpad не
оставались пустые иконки удалённых приложений. Раскладка Launchpad и файловые
ассоциации при этом не сбрасываются.
